...
<head>
        <meta charset="utf-8" />
        <title>Starter Checklist Edited</title>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <label for="msg" class="form-label">Thank you for editing Starter Checklist. Please proceed to the Office Induction.</label><a href="{{ route('induction.employee') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
