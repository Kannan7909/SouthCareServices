...
<!--                                <option value="registration_completed">All Users</option>
                               <option value="application_pending">Application Pending </option>
                                    ...
                                    <option value="DBS_under Review">DBS Under Review </option>
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <table class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td><i class="mdi mdi-circle text-primary"></i>DBS {{ $employee->dbs_status }}</td>
                                                    @endif
                                                    @if($employee->dbs_status == "Requested")
                                                    <td><i class="mdi mdi-circle text-danger"></i>DBS {{ $employee->dbs_status }}</td>
                                                    @endif
                                                    @if($employee->dbs_status == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>DBS {{ $employee->dbs_status }}</td>
                                                    @endif
                                                    @if($employee->dbs_status == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>DBS {{ $employee->dbs_status }}</td>
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.dbs',encrypt($employee->employee_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
