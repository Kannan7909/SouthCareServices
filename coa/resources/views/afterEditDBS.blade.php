        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for editing DBS check. Please proceed to the Reference Check.</label><a href="{{ route('reference.form') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
