...
<head>
        <meta charset="utf-8" />
        <title>Employee Contract Submitted</title>
<!--         <meta name="viewport" content="width=device-width, initial-scale=1.0">
 -->    <meta name="csrf-token" content="{{ csrf_token() }}">   
    ...
    <body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
        <!-- Begin page -->
        <div class="wrapper">
           @if( $employee->employee_contract == "Not Sent" )
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Employee Contract submission. Please check your email for further updates.
