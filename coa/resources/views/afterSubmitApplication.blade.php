           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Application submission. Please proceed to the Training Check.</label><a href="{{ route('training.form') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
