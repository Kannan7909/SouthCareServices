           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Training requst submission. Please proceed to the DBS Check.</label><a href="{{ route('dbs.check') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
