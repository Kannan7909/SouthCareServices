                    ...
                    <div class="row">
                            <div class="col-md-5">
                                <div class="page-title-box">                                   
                                    <h4 class="page-title">Contract Status</h4>
                                </div>
                            </div>
...
<!--                                <option value="registration_completed">All Users</option>
                                    ...
                                    <option value="contract_commented">Contract Commented </option>
                                    <option value="contract_under Review">Contract Under Review </option>
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <thead>   
                                                ...
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td><i class="mdi mdi-circle text-primary"></i>Contract {{ $employee->employee_contract }}</td>
                                                    @endif
                                                    @if($employee->employee_contract == "Commented")
                                                    <td><i class="mdi mdi-circle text-danger"></i>Contract {{ $employee->employee_contract }}</td>
                                                    @endif
                                                    @if($employee->employee_contract == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>Contract {{ $employee->employee_contract }}</td>
                                                    @endif
                                                    @if($employee->employee_contract == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>Contract {{ $employee->employee_contract }}</td>
                                                    @endif
                                                    <td>
