                    ...
                    <div class="row">
                            <div class="col-md-5">
                                <div class="page-title-box">                                   
                                    <h4 class="page-title">Starter Status</h4>
                                </div>
                            </div>
...
<!--                                <option value="registration_completed">All Users</option>
                                    ...
                                    <option value="starter_pending"> Starter Pending</option>
                                    <option value="starter_submitted"> Starter Submitted</option>
                                    <option value="starter_under Review">Starter Under Review </option>
                                    <option value="starter_approved"> Starter Approved</option>
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <thead>   
                                                ...
                                                <th>Actions</th>
                                                 ...
                                                 <tbody class="allData">
                                                 @if(count($starterData) == 0)
                                                 <tr>
                                                    <td align="center" colspan="10">No Data Found</td>
                                                </tr>
                                                @else
                                                 @foreach ($starterData as $employee)
                                                <tr>
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td><i class="mdi mdi-circle text-primary"></i>Starter {{ $employee->starter_status }}</td>
                                                    @endif
                                                    @if($employee->starter_status == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>Starter {{ $employee->starter_status }}</td>
                                                    @endif
                                                    @if($employee->starter_status == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>Starter {{ $employee->starter_status }}</td>
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.starter',encrypt($employee->employee_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
