...
<!--                             <img src="images/images-theme/mail_sent.svg" alt="mail sent image" height="64" />
 -->                            <h4 class="text-dark-50 text-center mt-4 fw-bold text-success">Password Changed!</h4>
                            <p class="text-muted mb-4">
<!--                                 A email has been send to <b>youremail@domain.com</b>.
 -->                                Your password has been changed successfully. To ensure your account's security, you will need to log in to the application with your updated credentials.
                            </p>
                        </div>
