                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Reference Check</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <label for="msg" class="form-label">Thank you for editing Reference check. Please proceed to the Health Check Questionnaire.</label><a href="{{ route('show.health') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
