                    ...
                    <div class="row">
                            <div class="col-md-5">
                                <div class="page-title-box">                                   
                                    <h4 class="page-title">Health Check Status</h4>
                                </div>
                            </div>
...
<!--                                <option value="registration_completed">All Users</option>
                                    ...
                                    <option value="health_pending"> Health Pending</option>
                                    <option value="health_submitted"> Health Submitted</option>
                                    <option value="health_under Review">Health Under Review </option>
                                    <option value="health_approved"> Health Approved</option>
                                ...
                                <div class="card">
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <thead>   
                                                ...
                                                @else
                                                 @foreach ($healthData as $employee)
                                                <tr>
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td><i class="mdi mdi-circle text-primary"></i>Health {{ $employee->health_status }}</td>
                                                    @endif
                                                    @if($employee->health_status == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>Health {{ $employee->health_status }}</td>
                                                    @endif
                                                    @if($employee->health_status == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>Health {{ $employee->health_status }}</td>
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.health',encrypt($employee->employee_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
