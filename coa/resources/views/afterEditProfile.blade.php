        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Your profile has been updated.</label><a href="{{ route('user.dashboard') }}" class="text-muted ms-1"><b style="color:red;"> Click here to see</b></a>
