            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <!-- start page title -->
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Application Form</h4>
                        ...
                        <form method="POST" action="{{ route('update.application') }}" class="update-application-form" id="update-application-form">
                        @csrf
                        <div class="row">
                            <div class="col-xl-12">
                                        ...
                                        <h4 class="header-title mt-0 mb-3">Personal Details</h4>
                                            ...
                                            <div class="row">   
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control" type="text" id="post_town" name="post_town" placeholder="Enter Your Post Town" value="{{ $employee->postTown }}" disabled>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                            ...
                                            <div class="row">
                                               ...
                                               <input type="date" class="form-control date required-personal" id="birthday" name="birthday" value="{{ $application->date_of_birth }}">
                                                </div>
                     <!--                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label for="marital_status" class="form-label">Marital Status </label>
                                                    <select name="marital_status" id="marital_status" class="form-control select2 required-personal form-select" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control required-personal" type="text" id="nationality" name="nationality" placeholder="Enter Your Nationality" value="{{ $application->nationality }}" required>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label for="ni" class="form-label">Do you have NI Number? </label>
                                                    <select name="have_ni" id="have_ni" class="form-control select2 required-personal form-select"  required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->have_ni == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->have_ni == "no" ? 'selected' : '' }}>No</option>
                                                    </select> 
                                                </div>
                                               
                                                @if( $application->have_ni == "yes" )
                                                <div class="col-md-4 mb-3" id="ni">
                                                    <label for="ni_number" class="form-label">NI Number </label>
                                                    <input class="form-control required-personal" type="text" id="ni_number" name="ni_number" placeholder="Enter Your NI Number" value="{{ $application->ni_number }}" onkeypress="return NINumCheck(event)">
                                                ...
                                                <div class="col-md-3 mb-3" id="ni" style="display:none">
                                                    <label for="ni_number" class="form-label">NI Number </label>
                                                    <input class="" type="text" id="ni_number" name="ni_number" placeholder="Enter Your NI Number" onkeypress="return NINumCheck(event)">
                                                    <span id="less-characters" class="hide-text" style="color:red;">
                                                    Should enter 9 characters
                                                    </span>
                                                </div>
                                                @endif     
                                                @if( $application->have_ni == "no" )
                                                <div class="col-md-3 mb-3" id="ni_reference">
                                                    <label for="ni_reference_number" class="form-label">NI Reference Number </label>
                                                    <input class="form-control required-personal" type="text" id="ni_reference_number" name="ni_reference_number" placeholder="Enter Your NI Reference Number" autocomplete=off value="{{ $application->ni_reference_number }}" onkeypress="return NIReferenceNumCheck(event)">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <select name="have_mnc" id="have_mnc" class="form-control select2 required-personal form-select">
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->have_mnc == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->have_mnc == "no" ? 'selected' : '' }}>No</option>
                                                    </select> 
                                                </div>
                                                
                                                @if( $application->have_mnc == "yes" )
                                                <div class="col-md-3 mb-3" id="mnc">
                                                    <label for="mnc_pin" class="form-label">NMC Pin </label>
                                                    <input class="form-control required-personal" type="text" id="mnc_pin" name="mnc_pin" placeholder="Enter Your NMC Pin" value="{{ $application->mnc_pin }}" onkeypress="return NMCNumCheck(event)">
                                                ...
                                                <div class="col-md-3 mb-3" id="mnc" style="display:none">
                                                    <label for="mnc_pin" class="form-label">NMC Pin </label>
                                                    <input class="" type="text" id="mnc_pin" name="mnc_pin" placeholder="Enter Your NMC Pin">
                                                </div>
                                                @endif     
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row">   
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control required-personal" type="text" id="relative_name" name="relative_name" placeholder="Enter Name" value="{{ $application->relative_name }}" required>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="relationship" class="form-label">Relationship</label>
                                                    <input class="form-control required-personal" type="text" id="relationship" name="relationship" placeholder="Enter Your Relationship" value="{{ $application->relationship }}" required>
                                                </div>
                                            </div>
                                           <!--  <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label for="relative_address" class="form-label">Address </label>
                                                    <textarea  class="form-control required-personal" id="relative_address" name="relative_address"  rows="3"  placeholder="Enter Address Of Your Relative" required>{{ $application->relative_address }}</textarea>
                                                </div>
                                             </div> -->
                                             <div class="row">   
                                                <div class="col-md-4 mb-3">
                                                    <label for="address1" class="form-label">Address Line One</label>
                                                    <input class="form-control" type="text" id="address1" name="address1" placeholder="Enter Address Line One" value="{{ $application->address1 }}" required>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="address1" class="form-label">Address Line Two (Optional)</label>
                                                    <input class="form-control" type="text" id="address2" name="address2" placeholder="Enter Address Line Two" value="{{ $application->address2 }}">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="address1" class="form-label">Address Line Three(Optional)</label>
                                                    <input class="form-control" type="text" id="address3" name="address3" placeholder="Enter Address Line Three" value="{{ $application->address3 }}">
                                                </div>
                                            </div> 
                                            <div class="row">   
                                                <div class="col-md-4 mb-3">
                                                    <label for="address1" class="form-label">Post Town</label>
                                                    <input class="form-control" type="text" id="post_town" name="post_town" placeholder="Enter Your Post Town" value="{{ $application->postTown }}">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="password" class="form-label">Postcode</label>
                                                    <input class="form-control" type="text" id="postcode" name="postcode" placeholder="Enter Your Postcode" value="{{ $application->postcode }}">
                                                </div>
                                            </div> 
                                             <div class="row">
                                                 <div class="col-md-2 mb-3">
                                                    <label for="country_code_mobile" class="form-label">Code</label>
                                                    <select name="relative_tel_code" id="relative_tel_code" class="form-control select2 form-select" data-toggle="select2" required>
                                    <option data-countryCode="IN" value="91" {{ $application->relative_tel_code == "91" ? 'selected' : '' }}>India (+91)</option>
                                    <option data-countryCode="GB" value="44" {{ $application->relative_tel_code == "44" ? 'selected' : '' }} >UK (+44)</option>
                                    <option data-countryCode="US" value="1" {{ $application->relative_tel_code == "1" ? 'selected' : '' }}>USA (+1)</option>
...
<!--                                     </optgroup>
 -->                                </select>                                                
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input class="form-control required-personal" type="text" id="relative_tel" name="relative_tel" onkeypress="return onlyNumberKeyContact(event)" placeholder="Enter Contact Number" value="{{ $application->relative_tel }}" required>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="country_code_mobile" class="form-label">Code</label>
                                                    <select name="relative_mobile_code" id="relative_mobile_code" class="form-control select2" data-toggle="select2" required>
                                    <option data-countryCode="IN" value="91" {{ $application->relative_mobile_code == "91" ? 'selected' : '' }}>India (+91)</option>
                                    <option data-countryCode="GB" value="44" {{ $application->relative_mobile_code == "44" ? 'selected' : '' }} >UK (+44)</option>
                                    <option data-countryCode="US" value="1" {{ $application->relative_mobile_code == "1" ? 'selected' : '' }}>USA (+1)</option>
<!--                                     <optgroup label="Other countries">
 -->                                        <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                                        <option data-countryCode="AD" value="376">Andorra (+376)</option>
                                        <option data-countryCode="AO" value="244">Angola (+244)</option>
...
<!--                                     </optgroup>
 -->                                </select> 
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="relative_mobile" class="form-label">Mobile No. </label>
                                                    <input class="form-control required-personal" type="text" id="relative_mobile" onkeypress="return onlyNumberKeyMobile(event)" name="relative_mobile" placeholder="Enter Mobile Number" value="{{ $application->relative_mobile }}" required>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input class="form-control required-personal" type="email" id="relative_email" name="relative_email" value="{{ $application->relative_email }}"  placeholder="Enter Email Address" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <button class="btn btn-primary toggle-disabled" type="button" onclick="applicationPersonalSubmit()"><!-- <i class="mdi mdi-account-circle"></i> --> Next </button>
                                                </div>
                                            </div>
...
<!--                                                     <input class="form-control required-passport" type="text" id="visa_status" name="visa_status" placeholder="Enter Visa Status" required>
 -->                                                <select name="visa_status" id="visa_status" class="form-control required-passport select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose Visa Status</option>
                                                        <option value="Dependant Visa" {{ $application->visa_status == "Dependant Visa" ? 'selected' : '' }}>Dependant Visa</option>
                                                        <option value="EU Settlement Scheme (EUSS)" {{ $application->visa_status == "EU Settlement Scheme (EUSS)" ? 'selected' : '' }}>EU Settlement Scheme (EUSS)</option>
                                                        <option value="Graduate Visa" {{ $application->visa_status == "Graduate Visa" ? 'selected' : '' }}>Graduate Visa</option>Not Applicable  
                                                        <option value="High Potential Individual (HPI) visa" {{ $application->visa_status == "High Potential Individual (HPI) visa" ? 'selected' : '' }}>High Potential Individual (HPI) visa</option>
                                                        <option value="Not Applicable" {{ $application->visa_status == "Not Applicable" ? 'selected' : '' }}>Not Applicable</option>
                                                        <option value="Other" {{ $application->visa_status == "Other" ? 'selected' : '' }}>Other (Please specify)</option>
                                                        <option value="Right of Abode" {{ $application->visa_status == "Right of Abode" ? 'selected' : '' }}>Right of Abode</option> 
                                                        <option value="Start-up or Innovator Visa " {{ $application->visa_status == "Start-up or Innovator Visa" ? 'selected' : '' }}>Start-up or Innovator Visa </option>
                                                        <option value="Student Visa" {{ $application->visa_status == "Student Visa" ? 'selected' : '' }}>Student Visa</option>
                                                        <option value="UK Ancestry visa" {{ $application->visa_status == "UK Ancestry visa" ? 'selected' : '' }}>UK Ancestry visa</option>
                                                        <option value="Work Visa" {{ $application->visa_status == "Work Visa" ? 'selected' : '' }}>Work Visa</option>                                                                                                                            
                                                    </select> 
                                                </div>
                                                @if( $application->visa_status == "Other" )
                                                <div class="col-md-3 mb-3" id="other" >
                                                    <label for="other_note" class="form-label">Please Specify</label>
                                                    <input class="form-control required-passport" type="text" id="other_note" name="other_note" placeholder="Please Specify" value="{{ $application->other_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="other" style="display:none">
                                                    <label for="other_note" class="form-label">Please Specify</label>
                                                    <input class="" type="text" id="other_note" name="other_note" placeholder="Please Specify">
                                                </div>
                                                @endif
                                                @if( $application->visa_status == "Dependant Visa" || $application->visa_status == "High Potential Individual (HPI) visa" || $application->visa_status == "Student Visa" || $application->visa_status == "UK Ancestry visa" || $application->visa_status == "Work Visa" )
                                                <div class="col-md-4 mb-3"  id="visa_details">
                                                    <label for="visa_expiry_date" class="form-label">Visa Expiry Date</label>
                                                    <input type="date" class="form-control required-passport date" id="visa_expiry_date" name="visa_expiry_date"  value="{{ $application->visa_expiry_date }}">
                                                </div>
                                                @else
                                                <div class="col-md-4 mb-3"  id="visa_details">
                                                    <label for="visa_expiry_date" class="form-label">Visa Expiry Date</label>
                                                    <input type="date" class="form-control date" id="visa_expiry_date" name="visa_expiry_date"  value="{{ $application->visa_expiry_date }}">
                                                </div>
                                                @endif
                                            </div>
                                            <div class="row">
                                             @if( $application->visa_status == "Dependant Visa" || $application->visa_status == "High Potential Individual (HPI) visa" || $application->visa_status == "Student Visa" || $application->visa_status == "UK Ancestry visa" || $application->visa_status == "Work Visa")
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control required-passport" type="text" id="passport_no" name="passport_no" placeholder="Enter Your Passport Number" value="{{ $application->passport_no }}">
                                                </div>
                                                @else
                                                <div class="col-md-4 mb-3">
                                                    <label for="passport_no" class="form-label">Passport No.</label>
                                                    <input class="form-control" type="text" id="passport_no" name="passport_no" placeholder="Enter Your Passport Number" value="{{ $application->passport_no }}">
                                                </div>
                                                @endif
                                                @if( $application->visa_status == "Dependant Visa" || $application->visa_status == "High Potential Individual (HPI) visa" || $application->visa_status == "Student Visa" || $application->visa_status == "UK Ancestry visa" || $application->visa_status == "Work Visa")
                                                <div class="col-md-4 mb-3">
                                                    <label for="place_of_issue" class="form-label">Passport Place Of Issue</label>
                                                    <input class="form-control required-passport" type="text" id="place_of_issue" name="place_of_issue" placeholder="Enter Place Of Issue"  value="{{ $application->place_of_issue }}">
                                                </div>
                                                @else
                                                <div class="col-md-4 mb-3">
                                                    <label for="place_of_issue" class="form-label">Passport Place Of Issue</label>
                                                    <input class="form-control" type="text" id="place_of_issue" name="place_of_issue" placeholder="Enter Place Of Issue"  value="{{ $application->place_of_issue }}">
                                                </div>
                                                @endif
                                            </div>
                                            ...
                                            @if( $application->visa_status == "Dependant Visa" || $application->visa_status == "High Potential Individual (HPI) visa" || $application->visa_status == "Student Visa" || $application->visa_status == "UK Ancestry visa" || $application->visa_status == "Work Visa")
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" class="form-control required-passport date" id="issue_date" name="issue_date" value="{{ $application->issue_date }}">
                                                </div>
                                                @else
                                                <div class="col-md-4 mb-3">
                                                    <label for="issue_date" class="form-label">Passport Issue Date</label>
                                                    <input type="date" class="form-control date" id="issue_date" name="issue_date" value="{{ $application->issue_date }}">
                                                </div>
                                                @endif
                                                @if( $application->visa_status == "Dependant Visa" || $application->visa_status == "High Potential Individual (HPI) visa" || $application->visa_status == "Student Visa" || $application->visa_status == "UK Ancestry visa" || $application->visa_status == "Work Visa")
                                                <div class="col-md-4 mb-3">
                                                    <label for="place_of_issue" class="form-label">Passport Expiry Date</label>
                                                    <input type="date" class="form-control date" id="expiry_date" name="expiry_date" value="{{ $application->expiry_date }}">
                                                </div>
                                                @else
                                                <div class="col-md-4 mb-3">
                                                    <label for="place_of_issue" class="form-label">Passport Expiry Date</label>
...
<!--                                                     <small id="" class="info-msg form-text text-muted"><i class="fa fa-lightbulb-o" style="font-size:24px"></i><b>Please click on the corresponding Upload button once the file is selected.</b></small>
 -->                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                @if(count($brpExpiry) == 0)
                                                <div class="col-md-3 mb-3">
                                                     <label for="place_of_issue" class="form-label">BRP Expiry Date</label>
                                                    <input type="date" class="form-control date" id="brp_expiry_date" name="brp_expiry_date">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3">
                                                     <label for="place_of_issue" class="form-label">BRP Expiry Date</label>
                                                    <input type="date" class="form-control date" id="brp_expiry_date" name="brp_expiry_date" value="{{ $brpExpiry[0]->expiry_date }}">
                                                </div>
                                                @endif
                                                <div class="col-md-3 mb-3">
                                         ...
                                         <!--    <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                 ...
                                                 <div class="col-md-3 mb-3">
                                                    <input class="btn btn-primary" type="button" id="rightSubmit" name="rightSubmit" value='Upload' required>
                                                </div>
                                            </div>  -->
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="sharecode" class="form-label">Do you have Employer Share Code? </label>
                                                    <select name="have_sharecode" id="have_sharecode" class="form-control select2 required-passport form-select">
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->have_sharecode == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="generated" {{ $application->have_sharecode == "generated" ? 'selected' : '' }}>No</option>
                                                    </select> 
                                                </div>
                                                <div class="col-md-3 mb-3" id="employer_sharecode">
                                                    <label for="sharecode" class="form-label">Share Code </label>
                                                    <input class="form-control required-passport" type="text" id="sharecode" name="sharecode" placeholder="Enter Your Share Code" value="{{ $application->sharecode }}">
                                                </div>
                                            </div>
                                                <div class="col-md-12 mb-3" id="sharecode_generator" style="display:none"><br/>
                                                Click on the link below to generate a share code which will be used by your employer to check your right to work in the UK.
                                        ...
                                        <h4 class="header-title mt-0 mb-3">Educational Details</h4>
                                            ...
                                            <table id="tbl">
                                                ...
                                                @foreach ($education as $education)               
                                                 <tr>
                                                     <td><input class="form-control mb-3 required-education" type="text" id="eduId" name="eduId" value="{{ $loop->iteration }}" disabled required></td>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="study_place{{ $loop->iteration }}" name="study_place{{ $loop->iteration }}" placeholder="Enter Your Study Place" value="{{ $education->study_place }}" required></td>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="qualification{{ $loop->iteration }}" name="qualification{{ $loop->iteration }}" placeholder="Enter Your Qualification" value="{{ $education->qualification }}" required></td> 
                                                    <td><input type="date" class="form-control mb-3" id="qualified_date{{ $loop->iteration }}" name="qualified_date{{ $loop->iteration }}" value="{{ $education->qualified_date }}" required></td>
                                                    <td><input class="form-control mb-3" type="file" id="docEducation{{ $loop->iteration }}" name="docEducation{{ $loop->iteration }}" onchange="uploadEducationDoc()"></td> 
                                                   <!--  @isset($educationDoc[$loop->iteration-1])
                                                    <td> <a target="_blank" href="{{ $educationDoc[$loop->iteration-1]->file_path}}"  data-toggle="tooltip" data-placement="right" title="Click here to view">{{ $educationDoc[$loop->iteration-1]->file_name}}</a> </td>
                                                    @endisset  -->
                                                    @if($loop->last)
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <input class="btn btn-primary" type="button" id="educationSubmit" name="educationSubmit" value='Update' required>
                                                </div>
                                                <hr>
                                            ...
                                            <table id="workTable">
                                                ...
                                                @else     
                                                 ...
                                                 <tr>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="workId" name="workId" value="{{ $loop->iteration }}" disabled required></td>
                                                    <td><input type="date" class="form-control mb-3" id="from{{ $loop->iteration }}" name="from{{ $loop->iteration }}" value="{{ $work->from }}"></td>
                                                    <td><input type="date" class="form-control mb-3" id="to{{ $loop->iteration }}" name="to{{ $loop->iteration }}" value="{{ $work->to }}"></td>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="employer_name{{ $loop->iteration }}" name="employer_name{{ $loop->iteration }}" placeholder="Enter Your Employer Name" value="{{ $work->employer_name }}"></td>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="business_type{{ $loop->iteration }}" name="business_type{{ $loop->iteration }}" placeholder="Enter Your Business Type" value="{{ $work->business_type }}"></td>
                                                    <td><input class="form-control mb-3 required-education" type="text" id="job_title{{ $loop->iteration }}" name="job_title{{ $loop->iteration }}" placeholder="Enter Your Job Title" value="{{ $work->job_title }}"></td>
                                                    <td><input class="form-control mb-3" type="file" id="docWork1" name="docWork1" onchange="uploadWorkDoc()"></td> 
                                                    @if($loop->last)
                                                    <td><input type="submit" class="button mb-3" value="+" title="Click to add more rows" onclick="addWorkField('workTable');" /></td>
                                                    @endif
                                                </tr> 
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <input class="btn btn-primary" type="button" id="workSubmit" name="workSubmit" value='Update' required>
                                                </div>
                                                <div class="row">
                                                <div class="col-md-8">
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <button class="btn btn-primary toggle-disabled" type="button" id="education-button" onclick="applicationEducationSubmit()"><!-- <i class="mdi mdi-account-circle"></i> --> Next </button>
                                                </div>
                                            </div>
			...
			the part of the company to limit their opportunity.
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="choose" id="choose" class="form-control select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="White" {{ $application->choose == "White" ? 'selected' : '' }}>White</option>
                                                        <option value="Mixed" {{ $application->choose == "Mixed" ? 'selected' : '' }}>Mixed</option>
                                                        <option value="Asian" {{ $application->choose == "Asian" ? 'selected' : '' }}>Asian</option>
                                                        <option value="Black" {{ $application->choose == "Black" ? 'selected' : '' }}>Black</option>
                                                        <option value="Chinese" {{ $application->choose == "Chinese" ? 'selected' : '' }}>Chinese</option>
                                                        <option value="Other" {{ $application->choose == "Other" ? 'selected' : '' }}>Other</option>
                                                    </select>
                                                </div>
                                             </div>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="gender" id="gender" class="form-control select2 form-select " required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="age" id="age" class="form-control select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="age1" {{ $application->age == "age1" ? 'selected' : '' }}>16-21</option>
                                                        <option value="age2" {{ $application->age == "age2" ? 'selected' : '' }}>22-25</option>
                                                        <option value="age3" {{ $application->age == "age3" ? 'selected' : '' }}>26-30</option>
                                                        <option value="age4" {{ $application->age == "age4" ? 'selected' : '' }}>31-35</option>
                                                        <option value="age5" {{ $application->age == "age5" ? 'selected' : '' }}>36-40</option>
                                                        <option value="age6" {{ $application->age == "age6" ? 'selected' : '' }}>41-50</option>
                                                        <option value="age7" {{ $application->age == "age7" ? 'selected' : '' }}>51-60</option>
                                                        <option value="age8" {{ $application->age == "age8" ? 'selected' : '' }}>61-65</option>
                                                    </select>
                                                </div>
                                             </div>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="disable" id="disable" class="form-control select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->disable == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->disable == "no" ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                @if( $application->disable == "yes" )
                                                <div class="col-md-3 mb-3" id="disability">
                                                    <input class="form-control required-equal" type="text" id="disability_note" name="disability_note" placeholder="Please specify" value="{{ $application->disability_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="disability" style="display:none">
                                                    <input class="" type="text" id="disability_note" name="disability_note" placeholder="Please specify">
                                                </div>
                                                @endif
                                             </div>
					...
					or that you may pose an actual or potential risk to children or vulnerable adults? </label>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="service" id="service" class="form-control select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->service == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->service == "no" ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                @if ( $application->service =='yes')
                                                <div class="col-md-3 mb-3" id="service_details">
                                                    <input class="form-control required-equal" type="text" id="service_note" name="service_note" placeholder="Please specify" value="{{ $application->service_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="service_details" style="display:none">
                                                    <input class="" type="text" id="service_note" name="service_note" placeholder="Please specify">
                                                </div>
                                                @endif
                                             </div>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="offence" id="offence" class="form-control select2 form-select required-equal" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->offence == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->offence == "no" ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                @if( $application->offence == "yes" )
                                                <div class="col-md-3 mb-3" id="offence_details">
                                                    <input class="form-control required-equal" type="text" id="offence_note" name="offence_note" placeholder="Please specify" value="{{ $application->offence_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="offence_details" style="display:none">
                                                    <input class="" type="text" id="offence_note" name="offence_note" placeholder="Please specify">
                                                </div>
                                                @endif
                                             </div>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="disciplinary_procedure" id="disciplinary_procedure" class="form-control select2 form-select" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->disciplinary_procedure == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->disciplinary_procedure == "no" ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                @if( $application->disciplinary_procedure == "yes" )
                                                <div class="col-md-3 mb-3" id="disciplinary_details">
                                                    <input class="form-control required-equal" type="text" id="disciplinary_note" name="disciplinary_note" placeholder="Please specify" value="{{ $application->disciplinary_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="disciplinary_details" style="display:none">
                                                    <input class="" type="text" id="disciplinary_note" name="disciplinary_note" placeholder="Please specify">
                                                </div>
                                                @endif
                                             </div>
                                             <hr>
		...
		Service.  </p>
                                            ...
                                            <div class="row">   
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <select name="criminal_offence" id="criminal_offence" class="form-control select2 form-select required-equal" required>
                                                        <option value="" disabled selected hidden>Choose One</option>
                                                        <option value="yes" {{ $application->criminal_offence == "yes" ? 'selected' : '' }}>Yes</option>
                                                        <option value="no" {{ $application->criminal_offence == "no" ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                @if( $application->criminal_offence == "yes" )
                                                <div class="col-md-3 mb-3" id="criminal_details">
                                                    <input class="form-control required-equal" type="text" id="criminal_note" name="criminal_note" placeholder="Please specify" value="{{ $application->criminal_note }}">
                                                </div>
                                                @else
                                                <div class="col-md-3 mb-3" id="criminal_details" style="display:none">
                                                    <input class="" type="text" id="criminal_note" name="criminal_note" placeholder="Please specify">
                                                </div>
                                                @endif
                                             </div>
...
<!--                                                      <input type="radio" value="yes" id="agree_declaration" name="agree_declaration" class="form-check-input">
 -->                                                                                                 
                                                  @if( $application->agree_declaration == "on" )
                                                     <input type="checkbox" class="required-equal" name="agree_declaration" id="agree_declaration" checked required>
                                                  @endif
...
-->                                             @if( $application->agree == "on" )
                                                     <input type="checkbox" class="required-equal" name="agree" id="agree" checked required>
                                                     @endif    
                                           ...
                                           <!--  <h4 class="header-title mt-0 mb-3">Notes</h4> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <button class="btn btn-primary toggle-disabled" type="button" id="equal-button" onclick="applicationEqualOpportunitySubmit()"> Next </button>
                                                </div>
                                            </div> 
                                     ...
                                     <div id="declaration-details" class="declaration-details">
                                        ...
                                        <hr>
                                            <div>
                                            <input type="checkbox" class="required-declaration" name="agree_submit" id="agree_submit" required>
                                            ...
                                            <div class="row">  
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input class="form-control required-declaration" type="text" id="name" name="name" placeholder="Enter The Name" value="{{ $application->name }}" onblur="createSign()" required onkeypress="return (event.charCode > 64 && 
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32) || (event.charCode ==46)">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input class="form-control required-declaration signature" type="text" id="signature" name="signature" placeholder="Enter The Signature" value="{{ $application->signature }}" readonly required>
                                                </div>
                                                <div class="col-md-1 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                     ...
                                                     <input type="date" class="form-control date required-declaration" id="date" name="date"  value="{{ $application->date }}" required>
                                                </div>
...
if (this.value === 'yes'){
    ...
    $("#sharecode").attr("class","form-control required-passport");
         ...
         $('#visa_status').on('change', function () {
            /* $('#update-application-form input[type="text"]').val('');
            $('#update-application-form input[type="date"]').val('');
            $('#update-application-form input[type="file"]').val(''); */
            $('#responseMsg').hide();
            ...
            $( "#passport-button" ).prop( "disabled", false );
...
//$('#passportSubmit').click(function(){
 ...
 if(files.length > 0){
    ...
    fd.append('file',files[0]);
    fd.append('_token',CSRF_TOKEN);
    fd.append('file_type','Education '+id);
