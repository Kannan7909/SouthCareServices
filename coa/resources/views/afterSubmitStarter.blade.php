           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Starter checklist submission. Please proceed to the Office Induction.</label><a href="{{ route('induction.employee') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
