...
<!--                                <option value="registration_completed">All Users</option>
                                    ...
                                    <option value="reference_under Review">Reference Under Review </option>
                                ...
                                <div class="card">
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <thead>
                                                ...
                                                @else
                                                 @foreach ($referenceData as $employee)
                                                <tr>
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td><i class="mdi mdi-circle text-primary"></i>Reference {{ $employee->reference_status }}</td>
                                                    @endif
                                                    @if($employee->reference_status == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>Reference {{ $employee->reference_status }}</td>
                                                    @endif
                                                    @if($employee->reference_status == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>Reference {{ $employee->reference_status }}</td>
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.reference',encrypt($employee->employee_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
        ...
        <script>
            $(document).ready(function(){
              $('#search').keyup(function(){
                ...
                $.ajax({
                    type:'get',
                    url: '{{ route('search.referenceList') }}',
                    data:{'search':$value},
