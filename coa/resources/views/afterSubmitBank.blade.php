           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Bank details submission. Please proceed to the Starter Checklist.</label><a href="{{ route('starter.checklist') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
