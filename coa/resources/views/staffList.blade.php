                    ...
                    <div class="row">
                            <div class="col-md-5">
                                <div class="page-title-box">                                   
                                    <h4 class="page-title">Staff Status</h4>
                                </div>
                            </div>
                                    ...
                                    <div id="education-work-details" class="education-work-details">
                                            ...
                                            <thead>
                                                ...
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('edit.staff',encrypt($employee->id)) }}" class="btn btn-primary" title="edit" data-toggle="tooltip">Edit</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
