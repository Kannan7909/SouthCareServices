                          ...
                          <!--  <div class="col-md-1"></div> -->
                            <div class="col-md-3">
                                ...
                                <select name="filter_status" id="filter_status" class="" required style="background-color:#f1f3fa">
                                    ...
                                    <option value="training_under Review">Training Under Review </option>
                                         ...
                                         <br>
                                            ...
                                            <thead>
                                                ...
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    <td>{{ $training->uk_contact_no }}</td>                                                    
                                                    <td>{{ $training->email }}</td>
                                                    @if($training->training_status == "Submitted")
                                                    <td><i class="mdi mdi-circle text-primary"></i>Training {{ $training->training_status }}</td>
                                                    @endif
                                                    @if($training->training_status == "Requested")
                                                    <td><i class="mdi mdi-circle text-danger"></i>Training {{ $training->training_status }}</td>
                                                    @endif
                                                    @if($training->training_status == "Under Review")
                                                    <td><i class="mdi mdi-circle text-warning"></i>Training {{ $training->training_status }}</td>
                                                    @endif
                                                    @if($training->training_status == "Approved")
                                                    <td><i class="mdi mdi-circle text-success"></i>Training {{ $training->training_status }}</td>
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.training',encrypt($training->employee_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
