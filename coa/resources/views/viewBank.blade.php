                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <h4 class="header-title mt-0 mb-3">Bank Details</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                 <p class="text-muted"><strong>Bank Name :</strong> <span class="ms-2">{{ $employee->bank_name }}</span></p>
                                            </div>
                                            <div class="col-md-4">
                                                 <p class="text-muted"><strong>Sort Code Number :</strong> <span class="ms-2">{{ $employee->sort_code }}</span></p>
                                            </div>
                                            <div class="col-md-4">
                                                 <p class="text-muted"><strong>Account Number :</strong> <span class="ms-2">{{ $employee->account_no }}</span></p>
                                            </div>
                                        </div>
                                        <div class="row">
                                             <div class="col-md-4">
                                                 <p class="text-muted"><strong>Account Holder Name :</strong> <span class="ms-2">{{ $employee->account_holder }}</span></p>
                                            </div>
                                            <div class="col-md-4">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="row">   
                                                ...
                                                <p class="text-muted"><strong>Current status of the user :</strong><span class="ms-2">{{ $bankEmployee[0]->bank_status }}</span></p>
                                            ...
                                            <div class="col-md-8">
                                                    <textarea  class="form-control required-personal" id="bank_comment" name="bank_comment"  rows="3"  placeholder="Enter Your Comment"  ></textarea>
                                            </div> </br>
                                            <div class="row">   
...
$('#approveButton').click(function(){
  ...
  success: function(result){
     console.log(result);
    // successFunction();
    window.location.href = "{{ route('bank.list') }}"
