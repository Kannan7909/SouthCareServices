    ...
    <div class="navbar-custom">
                    ...
                    <!-- start page title -->
                     <div class="row">
                            ...
                            <div class="app-search dropdown d-none d-lg-block col-md-3" style="margin-top: 18px;">
                                <form>
                                    <div class="input-group">
                                        <input type="text" class="form-control dropdown-toggle"  placeholder="Search..." id="search" name="search">
                                        <span class="mdi mdi-magnify search-icon"></span>
 ...
 -->                                     <table class="table table-striped dt-responsive nowrap w-100">
                                            <thead>
                                                ...
                                                <th scope="row">{{ $loop->iteration }}</th>
                                                    ...
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('view.finalCheck',encrypt($employee->user_id)) }}" class="btn btn-primary" title="View" data-toggle="tooltip">View</a>
                                                  </td>
                                                </tr> 
                                                @endforeach
                                                @endif
