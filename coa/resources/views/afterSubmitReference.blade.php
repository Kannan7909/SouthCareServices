           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Reference submission.Please proceed to the Health Check Questionnaire.</label><a href="{{ route('show.health') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
