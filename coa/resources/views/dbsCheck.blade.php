                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">DBS Check</h4>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                    <form method="POST" action="{{ route('save.dbs') }}" class="dbs-request-form" id="dbs-request-form">
                                         @csrf
                                        ...
                                        <div class="row">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="dbs" id="dbs" class="form-control select2 form-select required-dbs" required autocomplete=off>
...
<!--                                             <div>You will need to get an application form from us for your DBS check. We will contact you soon. Please click on the below button.</div>
 -->                                            We will contact you to organise your DBS check. Please get in touch with us if you do not hear within 3 working days. Please click on the below button.<br/>&nbsp;
                                            <!-- <div class="row">
 ...
 -->                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <label for="dbsFile" class="form-label">Choose File</label>
                                                    <input class="form-control required-dbs" type="file" id="dbsFile" name="dbsFile" onchange="dbsSubmit()" required>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                     <input class="form-control required-dbs" type="text" id="dbsNumber" name="dbsNumber" placeholder="Enter DBS Number" required autocomplete=off>
                                                </div>
                                            </div>
                                            </div> 
                                            <div class="row">
