                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">DBS Status</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="text-start">
                                        @foreach ($dbsEmployee as $employee)
                                        
                                        <div class="row">
                                            <div class="col-md-4">
                                                 <p class="text-muted"><strong>Name :</strong> <span class="ms-2">{{ $employee->firstname }} {{ $employee->surname }} </span></p>
                                            </div>
                                            
                                            <div class="col-md-4">
                                                 <p class="text-muted"><strong>DBS :</strong> <span class="ms-2">{{ $employee->have_dbs }}</span></p>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="col-md-4">
                                                <p class="text-muted"><strong>DBS Number :</strong><span class="ms-2">{{ $employee->dbsNumber }}</span></p>
                                            </div>
                                            @if(count($dbsDoc) == 0)
                                            <div class="col-md-4">
                                            ...
                                            @endif
                                            <div class="col-md-4">
                                                <p class="text-muted"><strong>Status :</strong> <span class="ms-2">{{ $employee->dbs_status }}</span></p>
                                            </div>
                                        </div>
                                    @endforeach
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="row">   
                                                ...
                                                <p class="text-muted"><strong>Current status of the user :</strong><span class="ms-2">{{ $dbsEmployee[0]->dbs_status }}</span></p>
                                            ...
                                            <div class="col-md-8">
                                                    <textarea  class="form-control required-personal" id="dbs_comment" name="dbs_comment"  rows="3"  placeholder="Enter Your Comment"  ></textarea>
                                            </div>
...
$('#approveButton').click(function(){
    ...
    var comment_section = "DBS";
    var comment=$("#dbs_comment").val();
    if(comment==""){
        comment="Nil";
    }
  ...
  success: function(result){
     console.log(result);
    // successFunction();
    window.location.href = "{{ route('dbs.list') }}"
