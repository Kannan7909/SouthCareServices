...
<head>
        <meta charset="utf-8" />
        <title>Edit Starter Checklist</title>
                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Edit Starter Checklist</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="card" id="instruction-details">
                                    <div class="card-body">
                                    <form method="POST" action="{{ route('update.starterForm') }}" class="starterChecklist-form" id="starterChecklist-form">
                                    @csrf
                                        <div class="row">
                                            ...
                                            @endif
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input class="form-control required-personal" type="text" id="insurance" name="insurance" placeholder="Enter Your Insurance Number" value="{{ $starter->insurance }}"  onkeypress="return insuranceNumCheck(event)">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" class="form-control date required-personal" id="start_date" name="start_date" value="{{ $starter->start_date }}" autocomplete=off>
                                                </div>
                                            </div>
                                             </br>
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <button class="btn btn-primary toggle-disabled" type="button" onclick="starterPersonalSubmit()"> Next </button>
                                                </div>
                                            </div>
                                         </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered table-striped dt-responsive nowrap w-100">
                                        ...
                                        <tr>
                                            <td>
                                                @if( $starter->statementA == "a" )
                                                <label class="form-check-label" for="agree"><b>Statement A applies to me</b></label>
                                                <input type="checkbox" class="required-statementA" id="statementA" name="statementA" value="a" autocomplete=off checked>
                                                @else
                                                <label class="form-check-label" for="agree"><b>Statement A applies to me</b></label>
                                            ...
                                            <td>
                                                @if( $starter->statementB == "b" )
                                                <label class="form-check-label" for="agree"><b>Statement B applies to me</b></label>
                                                <input type="checkbox" class="required-statementB" id="statementB" name="statementB" value="b" autocomplete=off checked>
                                                @else
                                                <label class="form-check-label" for="agree"><b>Statement B applies to me</b></label>
                                            ...
                                            <td>
                                                @if( $starter->statementC == "c" )
                                                <label class="form-check-label" for="agree"><b>Statement C applies to me</b></label>
                                                <input type="checkbox" class="required-statementC" id="statementC" name="statementC" value="c" autocomplete=off checked>
                                                @else
                                                <label class="form-check-label" for="agree"><b>Statement C applies to me</b></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-0 d-grid text-center">
                                                    <button class="btn btn-primary toggle-disabled" type="button" id="statementSubmit" onclick="starterStatementSubmit()"> Next </button>
                                                </div>
                                            </div>
                                         </div>
                                    </div>
                                        ...
                                        <div class="row">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="loan" id="loan" class="form-control select2 form-select" required autocomplete=off>
                                                    ...
                                                    <option value="Yes" {{ $starter->loan == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->loan  == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="row" id="completedQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="completed" id="completed" class="form-control select2 form-select" autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Yes" {{ $starter->is_complete == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->is_complete == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="row" id="debitQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="debit" id="debit" class="form-control select2 form-select" autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Yes" {{ $starter->is_debit == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->is_debit == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="row" id="planQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="loan_plan" id="loan_plan" class="form-control select2 form-select" autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Plan 1" {{ $starter->loan_plan == "Plan 1" ? 'selected' : '' }}>Plan 1</option>
                                                    <option value="Plan 2" {{ $starter->loan_plan == "Plan 2" ? 'selected' : '' }}>Plan 2</option>
                                                    <option value="Both" {{ $starter->loan_plan == "both" ? 'selected' : '' }}>Both</option>
                                                </select>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="row" id="pgLoanQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="pg_loan" id="pg_loan" class="form-control select2 form-select" required autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Yes" {{ $starter->pg_loan == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->pg_loan == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="row" id="pgCompleteQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="pg_complete" id="pg_complete" class="form-control select2 form-select" autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Yes" {{ $starter->is_pg_complete == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->is_pg_complete == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div> 
                                        <div class="row" id="pgDebitQuestion">   
                                            ...
                                            <div class="col-md-2 mb-3">
                                                <select name="pg_debit" id="pg_debit" class="form-control select2 form-select" autocomplete=off>
                                                    <option value="" disabled selected hidden>Choose One</option>
                                                    <option value="Yes" {{ $starter->pg_debit == "Yes" ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ $starter->pg_debit == "No" ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>  
                                        ...
                                        <hr>
                                            ...
                                            <div class="row">  
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input class="form-control required-declaration" type="text" id="full_name" name="full_name" placeholder="Enter The Name"  onblur="createSign()" required value="{{ $starter->full_name }}" autocomplete=off onkeypress="return (event.charCode > 64 && 
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode ==32) || (event.charCode ==46)">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input class="form-control required-declaration signature" type="text" id="signature" name="signature"  readonly required value="{{ $starter->signature }}" autocomplete=off>
                                                </div>
                                                <div class="col-md-1 mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                     ...
                                                     <input type="date" class="form-control date required-declaration" id="date" name="date"  value="{{ $starter->date }}" required autocomplete=off>
                                                </div>
