           ...
           @include('navigationMenu')
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <label for="msg" class="form-label">Thank you for the Health Check Questionnaire submission. Please proceed to the Bank details.</label><a href="{{ route('bank.details') }}" class="text-muted ms-1"><b style="color:red;">Click Here</b></a>
